...
<div id="content">
    <div id="board">
     ...
     <div  style="display:flex;justify-content: center; margin-top:20px"><el-button type="primary" @click="restart()">再来一局</el-button></div> 
    </div>
    <el-dialog
      title="新游戏"
      center
    v-model="isDialogShow"
      ...
      <span slot="footer" class="">
        ...
        <el-button type="primary" @click="canter()">取消</el-button>
      </span>
    </el-dialog>
  </div>
</template>
  ...
  export default {
    ...
    methods: {
      ...
      start(){
        ...
        //初始化棋盘
        $("#board").css("width", (this.config.width+2) * this.config.blockSize + (this.config.blockSize/20) )
          .css("height", (this.config.height+2) * this.config.blockSize+ (this.config.blockSize/20));
